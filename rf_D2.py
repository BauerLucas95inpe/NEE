...
# ==============================================================================
print("--- Loading data RF D1 SS Experiment 7 Key Features ---")
...
Data = Data.dropna()
Data = Data["TIMESTAMP","NEE","SWVL4","STL3","STL2","STL4","LE","SW","PPFD"]
...
trials_df_rf_cv.to_csv('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_trials_df_rf_d1_ss.csv', index=False, sep=',')
...
plt.tight_layout()
fig1.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_rf_d1_ss_dispersion.png', dpi=400)
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_rf_d1_ss.png', dpi=400)
plt.close(fig2)
...
plt.tight_layout()
fig3.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_comparisons_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig3)
...
plot_performance_diagram(sink_plot_data, '', '/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_rf_performance_diagram_sink_d1_ss.png', 'Critical success index for sink scenarios - CSI')
plot_performance_diagram(source_plot_data, '', '/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_rf_performance_diagram_source_d1_ss.png', 'Critical success index for source scenarios - CSI')
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_beeswarm_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_shap_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

print("\n--- Script finished successfully RF D1 SS 7 Key Features---")