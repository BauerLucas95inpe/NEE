...
selected_features = ['SWVL4', 'LE', 'SW', 'LAI', 'NETRAD', 'VPD', 'TA']
...
trials_df_mlp_d2_ss_cv.to_csv('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_trials_df_mlp_d2_ss.csv', index=False, sep=',')
...
plt.tight_layout()
fig1.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_mlp_d2_ss_dispersion.png', dpi=400)
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_mlp_d2_ss.png', dpi=400)
plt.close(fig2)
...
plt.tight_layout()
fig3.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_comparisons_mlp_d2_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig3)
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_mlp_performance_diagram_sink_d2_ss.png',
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_mlp_performance_diagram_source_d2_ss.png',
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_beeswarm_mlp_d2_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mrmr_shap_bar_mlp_d2_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)


print("\n--- Script finished successfully MRMR MLP D2 SS 7 Key Features ---")