...
# ==============================================================================
print("--- Loading data RF D1 SS Experiment ---")
Data = pd.read_csv("/scratch/cptec/lucas.bauer/nee_ga_project/data/NEE_QC_1.csv", header=0, decimal='.', sep=",", na_values=-9999)
...
# ==============================================================================
# --- 2. OPTUNA HYPERPARAMETER TUNING (Seasonal Generalization) ---
# ==============================================================================
GLOBAL_SEED = 23
...
def objective(trial):
    ...
    max_features = trial.suggest_int('max_features', low=1, high=20) 
...
trials_df_rf_cv.to_csv('/scratch/cptec/lucas.bauer/nee_ga_project/data/trials_df_rf_d1_ss.csv', index=False, sep=',')
...
plt.tight_layout()
fig1.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/rf_d1_ss_dispersion.png', dpi=400)
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/rf_d1_ss.png', dpi=400)
plt.close(fig2)
...
ax3.set_xticklabels(tick_labels, rotation=0) # Rotação para não embolar

ax3.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, frameon=True, edgecolor='black')

sns.despine(bottom=True, left=True)
plt.tight_layout()
fig3.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/comparisons_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig3)
...
plot_performance_diagram(sink_plot_data, '', '/scratch/cptec/lucas.bauer/nee_ga_project/data/rf_performance_diagram_sink_d1_ss.png', 'Critical success index for sink scenarios - CSI')
plot_performance_diagram(source_plot_data, '', '/scratch/cptec/lucas.bauer/nee_ga_project/data/rf_performance_diagram_source_d1_ss.png', 'Critical success index for source scenarios - CSI')
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/max_beeswarm_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

# Beeswarm (Top 10)
fig = plt.figure(figsize=(10, 6))
shap.summary_plot(shap_values_train, X_train_final, feature_names=feature_names, show=False, max_display=10)

plt.xlabel(r"SHAP values (Contributions to NEE, $\mu mol \ m^{-2} s^{-1}$)", fontsize=14)
plt.xticks(fontsize=12); plt.yticks(fontsize=12)
plt.tight_layout()

fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/beeswarm_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/max_shap_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
plt.xticks(fontsize=12); plt.yticks(fontsize=12)
plt.tight_layout()
shap.summary_plot(shap_values_train, X_train_final, feature_names=feature_names, plot_type="bar", show=False, max_display=10)
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/shap_rf_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

print("\n--- Script finished successfully RF D1 SS---")