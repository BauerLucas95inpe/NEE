...
# ==============================================================================
print("--- Loading data MLP D1 SS Experiment 7 Key Features ---")
...
Data = Data.dropna()
Data = Data[["TIMESTAMP","NEE","SWVL4","LE","STL3","SW","NETRAD","PPFD","STRD"]]
...
trials_df_mlp_d1_ss_cv.to_csv('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_trials_df_mlp_d1_ss.csv', index=False, sep=',')
...
# 1. Gráfico de Dispersão (Regressão Linear)
...
plt.tight_layout()
fig1.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mlp_d1_ss_dispersion.png', dpi=400)
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mlp_d1_ss.png', dpi=400)
plt.close(fig2)
...
plt.tight_layout()
fig3.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_comparisons_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig3)
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mlp_performance_diagram_sink_d1_ss.png',
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_mlp_performance_diagram_source_d1_ss.png',
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_beeswarm_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/7k_shap_bar_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

print("\n--- Script finished successfully MLP D1 SS 7 Key Features ---")