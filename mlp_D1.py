...
# ==============================================================================
print("--- Loading data MLP D1 SS Experiment ---")
...
trials_df_mlp_d1_ss_cv = study.trials_dataframe()
trials_df_mlp_d1_ss_cv.to_csv('/scratch/cptec/lucas.bauer/nee_ga_project/data/trials_df_mlp_d1_ss.csv', index=False, sep=',')
...
plt.tight_layout()
fig1.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/mlp_d1_ss_dispersion.png', dpi=400)
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/mlp_d1_ss.png', dpi=400)
plt.close(fig2)
...
plt.tight_layout()
fig3.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/comparisons_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig3)
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/mlp_performance_diagram_sink_d1_ss.png',
...
plot_performance_diagram(
    ...
    title='',
    save_path='/scratch/cptec/lucas.bauer/nee_ga_project/data/mlp_performance_diagram_source_d1_ss.png',
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/max_beeswarm_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)


fig = plt.figure(figsize=(10, 6))
shap.summary_plot(shap_values_train, X_train_np, feature_names=feature_names, show=False, max_display=10)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/beeswarm_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/max_shap_bar_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

fig = plt.gcf()
fig.set_size_inches(10, 6)
shap.summary_plot(shap_values_train, X_train_np, feature_names=feature_names, plot_type="bar", show=False, max_display=10)
plt.xlabel(r"Mean (|SHAP value|) (Mean contributions to NEE, $\mu mol \ m^{-2} s^{-1}$)", fontsize=14)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.ylabel("", fontsize=14)
...
fig.savefig('/scratch/cptec/lucas.bauer/nee_ga_project/data/shap_bar_mlp_d1_ss.png', dpi=400, bbox_inches='tight')
plt.close(fig)

print("\n--- Script finished successfully MLP D1 SS ---")